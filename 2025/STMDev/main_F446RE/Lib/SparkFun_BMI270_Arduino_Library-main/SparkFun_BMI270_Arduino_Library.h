...
class BMI270
{
    public:
        ...
        int8_t beginI2C(uint8_t address, I2C_HandleTypeDef* hi2c);
    ...
    private:
        ...
        static BMI2_INTF_RETURN_TYPE readRegistersI2C( uint8_t reg,uint8_t* data,uint32_t len,BMI270_InterfaceData* ifc);
        ...
        static BMI2_INTF_RETURN_TYPE writeRegistersI2C(uint8_t reg,const uint8_t* data,uint32_t len,BMI270_InterfaceData* ifc);
