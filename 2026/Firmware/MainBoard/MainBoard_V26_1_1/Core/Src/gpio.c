...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI2_CS_Pin|LED1_Pin|LED2_Pin|LED0_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI2_CS_Pin LED1_Pin LED2_Pin LED0_Pin */
  GPIO_InitStruct.Pin = SPI2_CS_Pin|LED1_Pin|LED2_Pin|LED0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
